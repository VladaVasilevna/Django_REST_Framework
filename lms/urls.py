...
from .views import CourseSubscriptionView, CourseViewSet, LessonDetail, LessonListCreate
...
urlpatterns = [
    ...
    path("subscriptions/", CourseSubscriptionView.as_view(), name="subscription"),
]
